...
define(["exports", "scenegraph", "animation"], function (
	 ...
	 */
	function init() {
		const cube = scenegraph.createNodeWithModel("cube", "cube");
		
		// const myModel = scenegraph.createNodeWithModel("myModel", "myModel");
		// myModel.rotateTo([6.5, -0.9, 0]);
		// myModel.translate([-140, -320, 0], true);
